...
//    if (typeof (response.isSuccessStatusCode) != 'undefined' && !typeof (response.isSuccessStatusCode))
//        throw ({ isSuccessStatusCode, errors, statusCode } = response)
//    else {
//        const result = response.Data;
//        if (typeof (result.messages) != 'undefined') {

//            const {  messages, data: responseData, dataCount: count } = result;
//            let data;
//            if (count == 1)
//                data = [...responseData].shift();
//            else
//                data = responseData
//            const [message] = messages;
//            return { message, data }
//        } else if (typeof (result.Messages) != 'undefined') {
//            const { Messages: messages, Data: responseData, DataCount: count } = result
//            let data;
//            if (count == 1)
//                data = [...responseData].shift();
//            else
